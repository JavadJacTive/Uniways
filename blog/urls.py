...
from blog.views import teacher_profile_view, student_profile_view, upload_post, go_to_upload_post, go_to_profile_page
...
urlpatterns = [
    ...
    # Page Profile
    path('teacher/profile/<int:teacher_id>/EditProfile/', go_to_profile_page, name='go_to_editpfl_name'), # Edit Profile
